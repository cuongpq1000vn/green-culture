...
export interface ApiFacilityFacility extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Production and processing facilities';
  ...
  attributes: {
    ...
    established: Schema.Attribute.Date;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    type: Schema.Attribute.Enumeration<
      ['warehouse', 'processing', 'packaging', 'logistics', 'office']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGlobalPartnerGlobalPartner
  ...
  info: {
    description: 'International partners and markets';
    displayName: 'Global Partner';
    pluralName: 'global-partners';
    singularName: 'global-partner';
  };
  options: {
    comment: '';
    draftAndPublish: true;
  ...
  attributes: {
    activeProducts: Schema.Attribute.Relation<
      'manyToMany',
      'api::product.product'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    exportVolume: Schema.Attribute.String;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    flag: Schema.Attribute.Media<'images'>;
    flagEmoji: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 10;
      }>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global-partner.global-partner'
    > &
      Schema.Attribute.Private;
    mapImage: Schema.Attribute.Media<'images'>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    partnerCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    partnerSince: Schema.Attribute.Date;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearsCooperation: Schema.Attribute.String;
  };
}
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    partnersSection: Schema.Attribute.JSON;
    processSection: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainNavigation: Schema.Attribute.Component<'shared.nav-item', true>;
    mobileNavigation: Schema.Attribute.Component<'shared.nav-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    secondaryNavigation: Schema.Attribute.Component<'shared.link', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProcessStepProcessStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Steps in the production and export process';
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    qualityChecks: Schema.Attribute.JSON;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Agricultural products for export';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    gallery: Schema.Attribute.Media<'images', true>;
    harvestSeason: Schema.Attribute.String;
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    companyInfo: Schema.Attribute.JSON;
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'EGO Agricultural Export'>;
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Statistical data for home and about pages';
    displayName: 'Stat';
    pluralName: 'stats';
    singularName: 'stat';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['home', 'about']> &
      Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::global-partner.global-partner': ApiGlobalPartnerGlobalPartner;
